...
function Wallpaper(props) {
  ...
  let getLocationList = async (event) => {
    ...
    let URL = "https://polar-oasis-08997.herokuapp.com/api/get-location-by-city?city=" + city;
    try {
  ...
  let getRestaurantDetails = async (event) => {
    ...
    let URL = `https://polar-oasis-08997.herokuapp.com/api/get-restaurant-by-location-id?lid=${selectLoc.location_id}&rest=${restaurant}`;
    try {
      let response = await axios.get(URL);
